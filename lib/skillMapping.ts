...
export const skillMapping: Record<string, SkillSuggestion> = {
  ...
  "content-center": {
    ...
    tips: [
      "【文案生成】选平台→定类型→挑语气→输入主题→一键生成 3 版文案，覆盖 6 大平台 × 5 种类型 × 6 种风格",
      "【素材管理】五大分类（文案模板/品牌素材/SOP/竞品截图/收藏），支持搜索、标签、关联活动",
      "【生成即保存】在文案生成 tab 生成的文案可一键保存到素材库，实现内容生产→沉淀→复用的完整闭环",
      "【活动关联】素材可关联到活动管理，活动上下文直接引用对应文案和素材",
  ...
  "user-center": {
    ...
    tips: [
      ...
      "【项目仪表盘】7 项关键指标实时统计——活动、内容、竞品、知识、数据集、成员、在线数",
      "【全局日志】聚合来自运营日历、内容中心、知识库的操作记录，按时间倒序排列",
      "【成员详情】点击成员卡片查看详细信息：角色、加入时间、技能标签、当前状态",
    ],
  },
  knowledge: {
